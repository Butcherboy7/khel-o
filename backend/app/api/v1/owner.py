...
async def get_onboarding_draft(
    ...
    snapshot = {
        ...
        "state": cafe.state,
        "pincode": cafe.pincode,
        "latitude": float(cafe.latitude) if cafe.latitude is not None else None,
        "longitude": float(cafe.longitude) if cafe.longitude is not None else None,
        "googleMapsUrl": cafe.google_maps_url or "",
        "phoneNumber": cafe.phone_number,
        "email": cafe.email or "",
        "businessPan": cafe.business_pan or "",
        "hasGst": bool(cafe.gstin),
        "gstin": cafe.gstin or "",
        "legalDocumentUrl": cafe.legal_document_url or "",
        ...
        "instagram": (cafe.social_links or {}).get("instagram", ""),
        "discord": (cafe.social_links or {}).get("discord", ""),
        "hardwareTiers": [
            {
                "id": str(t.id),
