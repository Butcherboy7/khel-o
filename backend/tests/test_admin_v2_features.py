...
# caller was already deleted in an earlier task) and has since been deleted
# as part of the final-branch-review cleanup. The equivalent "refunded
# bookings are excluded from outstanding balance" behavior is still covered
# by test_cafe_payout_repository.py::test_outstanding_amount_excludes_refunded_booking.
