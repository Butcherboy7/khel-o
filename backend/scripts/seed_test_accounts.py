    ...
    async with AsyncSessionLocal() as db:
        ...
        if not verified_cafe:
            verified_cafe = Cafe(
                ...
                photos=[{"url": "https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=1200&auto=format&fit=crop", "category": "exterior"}],
                supported_games={"pc": ["Valorant", "Counter-Strike 2", "EA Sports FC 24", "GTA V"]},
