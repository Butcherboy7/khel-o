...
export default function NotificationsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto pb-24">
      {/* Header */}
      <div className="sticky top-0 z-10 bg-card/95 backdrop-blur-md border-b border-border/60 px-4 py-4">
      ...
      <div className="px-4 py-4">
        ...
        {!isLoading && !isError && notifications.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-body text-text-secondary">No new notifications at this time.</p>
          </div>
        )}
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-caption text-text-secondary mb-1 leading-relaxed">
                      {n.message}
                    </p>
